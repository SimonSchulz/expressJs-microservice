...
export class secretQuestionCheck1673898905603 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "client" ADD "secQuestionInvalidAttempts" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "client" DROP COLUMN "secQuestionInvalidAttempts"`);
    }
